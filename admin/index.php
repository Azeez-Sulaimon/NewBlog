...
<?php
    ...
    $unapproved_comments_count = mysqli_num_rows($select_unapproved_comments_query);   
    
    $query = "SELECT * FROM users WHERE user_role = 'subscriber' ";
    $select_user_role_query = mysqli_query($connection, $query);
    $user_role_count = mysqli_num_rows($select_user_role_query);              
?>
...
$element_text = ['All Posts','Active Posts','Draft Posts','All Comments','Pending Comments', 'Users','Subscribers', 'Categories'];
$element_count = [ $posts_count, $published_posts_count, $draft_posts_count, $comments_count,$unapproved_comments_count,  $users_count, $user_role_count,  $categories_count]; 
